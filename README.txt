...
Note: Run echo $NODE_ENV to check node enviroment if set to 'production' run 'unset NODE_ENV' then try to run 'npm i' again. If it still doesn't work install packages using the below command. 
